...
@Configuration
@EnableTransactionManagement //manage all my transactions
@EnableJpaRepositories(basePackages = "lk.ijse.spring.repo") //link dao class
public class JPAConfig {

    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, JpaVendorAdapter adapter) {
        LocalContainerEntityManagerFactoryBean bean = new LocalContainerEntityManagerFactoryBean();
        bean.setPackagesToScan("lk.ijse.spring.entity"); //set entity location
    ...
    public DataSource dataSource() {
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/springJPA?createDatabaseIfNotExist=true");  //jdbc driver location and
        // create database too
